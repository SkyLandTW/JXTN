...
public final class NativeFiles2 extends JNIBase {

    /* copy */

    public static int copy(Path oldpath, Path newpath) {
    ...
    public static int copyat(int olddirfd, Path oldpath, int newdirfd, Path newpath) {
        return copyat(olddirfd, tPath(oldpath), newdirfd, tPath(newpath));
    }

    public static int copyat(int olddirfd, String oldpath, int newdirfd, String newpath) {
        return copyat(olddirfd, tPath(oldpath), newdirfd, tPath(newpath));
    }
