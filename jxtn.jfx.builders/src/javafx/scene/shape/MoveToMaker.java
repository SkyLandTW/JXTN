 ...
 * @version jfxrt.jar
 * @param <Z> 要建構的物件型態(需繼承{@link MoveTo})
 * @param <B> 建構器本身的型態(需繼承{@link MoveToMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class MoveToMaker<Z extends MoveTo, B extends MoveToMaker<Z, B>>
        extends javafx.scene.shape.PathElementMaker<Z, B>
        implements MoveToMakerExt<Z, B>
{
    ...
    /**
     * 設定屬性{@link MoveTo#xProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 設定屬性{@link MoveTo#yProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
