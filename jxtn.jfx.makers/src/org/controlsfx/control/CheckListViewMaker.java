...
public class CheckListViewMaker<T extends java.lang.Object, Z extends CheckListView<T>, B extends CheckListViewMaker<T, Z, B>>
        extends javafx.scene.control.ListViewMaker<T, Z, B>
        implements CheckListViewMakerExt<T, Z, B>
{
