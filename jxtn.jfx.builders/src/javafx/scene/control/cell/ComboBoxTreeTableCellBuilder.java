...
/**
 * {@link ComboBoxTreeTableCell}建構器。
 *
...
public class ComboBoxTreeTableCellBuilder<S extends java.lang.Object, T extends java.lang.Object, Z extends ComboBoxTreeTableCell<S, T>, B extends ComboBoxTreeTableCellBuilder<S, T, Z, B>>
        extends javafx.scene.control.TreeTableCellBuilder<S, T, Z, B>
        implements ComboBoxTreeTableCellBuilderExt<S, T, Z, B>
{
    ...
    /**
     * 設定集合屬性{@link ComboBoxTreeTableCell#getItems}的內容。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
    ...
    /**
     * 增加集合屬性{@link ComboBoxTreeTableCell#getItems}的內容。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 設定屬性{@link ComboBoxTreeTableCell#comboBoxEditableProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 設定屬性{@link ComboBoxTreeTableCell#converterProperty}的連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 設定屬性{@link ComboBoxTreeTableCell#converterProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 建構{@link ComboBoxTreeTableCell}物件。
     *
     * @return 新的{@link ComboBoxTreeTableCell}物件實體
     */
    @Override
    @SuppressWarnings("unchecked")
    public ComboBoxTreeTableCell<S, T> build()
    {
        ComboBoxTreeTableCell<S, T> instance = new ComboBoxTreeTableCell<S, T>();
     ...
     */
    @SuppressWarnings("unchecked")
    public ComboBoxTreeTableCell<S, T> build(T[] arg0)
    {
        ComboBoxTreeTableCell<S, T> instance = new ComboBoxTreeTableCell<S, T>(arg0);
        this.applyTo((Z) instance);
        this.doAfterBuild((Z) instance);
        return instance;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public ComboBoxTreeTableCell<S, T> build(javafx.collections.ObservableList<T> arg0)
    {
        ComboBoxTreeTableCell<S, T> instance = new ComboBoxTreeTableCell<S, T>(arg0);
        this.applyTo((Z) instance);
        this.doAfterBuild((Z) instance);
