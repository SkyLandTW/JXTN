...
<#if !class.@name?ends_with("Event") && !class.@name?ends_with("Model") && class.constructor?size != 0 && class.constructor[0].@access == "public">
     ...
     *
     * @return 新的{@link ${class.@package}.${class.@name}Maker}
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public static<#if class.@genericDeclaration != ""> <${class.@genericDeclaration}></#if> ${class.@package}.${class.@name}Maker<${class.@genericParamPrepend}${class.@package}.${class.@genericName}, ?> ${class.@name?uncap_first}()
    {
        return new ${class.@package}.${class.@name}Maker();
    }
</#if>
</#list>
</#list>
...
<#assign fileName = "/" + class.@package?replace(".", "/") + "/" + class.@name+"Maker.java">
<@pp.changeOutputFile name=fileName />
<@pp.warning message=fileName />
// @formatter:off
/*
...
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class ${class.@name}Maker<${class.@genericDeclarationPrepend}Z extends ${class.@genericName}, B extends ${class.@name}Maker<${class.@genericParamPrepend}Z, B>>
    <#if class.@super != "">
        extends ${class.@super}Maker<${class.@superParamPrepend}Z, B>
    <#else>
        extends jxtn.jfx.makers.AbstractMaker<Z, B>
    </#if>
        implements ${class.@name}MakerExt<${class.@genericParamPrepend}Z, B>
{
 <#-- 一般屬性欄位 -->
...
<#assign fileName = "/" + class.@package?replace(".", "/") + "/" + class.@name+"MakerExt.java">
...
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public interface ${class.@name}MakerExt<${class.@genericDeclarationPrepend}Z extends ${class.@genericName}, B extends ${class.@name}Maker<${class.@genericParamPrepend}Z, B>>
    <#if class.@super != "">
        extends ${class.@super}MakerExt<${class.@superParamPrepend}Z, B>
    <#else>
