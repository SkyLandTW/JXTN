...
public class TextFieldMaker<Z extends TextField, B extends TextFieldMaker<Z, B>>
        extends javafx.scene.control.TextInputControlMaker<Z, B>
        implements TextFieldMakerExt<Z, B>
{
