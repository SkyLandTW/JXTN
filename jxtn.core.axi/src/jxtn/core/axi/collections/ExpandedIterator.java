...
public class ExpandedIterator<T, R> extends AbstractIterator<R>
{
     ...
     * 展開函數
     */
    protected final Function<? super T, Iterator<R, RuntimeException>> expand;

    protected Iterator<R, RuntimeException> currentChildren;
     ...
     * @param expand 展開函數
     */
    public ExpandedIterator(Iterator<T, RuntimeException> source, Function<? super T, Iterator<R, RuntimeException>> expand)
    {
