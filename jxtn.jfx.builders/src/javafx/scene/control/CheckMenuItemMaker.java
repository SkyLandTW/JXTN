 ...
 * @version jfxrt.jar
 * @param <Z> 要建構的物件型態(需繼承{@link CheckMenuItem})
 * @param <B> 建構器本身的型態(需繼承{@link CheckMenuItemMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class CheckMenuItemMaker<Z extends CheckMenuItem, B extends CheckMenuItemMaker<Z, B>>
        extends javafx.scene.control.MenuItemMaker<Z, B>
        implements CheckMenuItemMakerExt<Z, B>
{
