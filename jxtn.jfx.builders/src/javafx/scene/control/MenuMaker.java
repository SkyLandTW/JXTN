 ...
 * @param <B> 建構器本身的型態(需繼承{@link MenuMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class MenuMaker<Z extends Menu, B extends MenuMaker<Z, B>>
        extends javafx.scene.control.MenuItemMaker<Z, B>
        implements MenuMakerExt<Z, B>
{
    ...
    /**
     * 增加集合屬性{@link Menu#getItems}的內容，排除null項目。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
