...
public class ComboBoxListCellMaker<T extends java.lang.Object, Z extends ComboBoxListCell<T>, B extends ComboBoxListCellMaker<T, Z, B>>
        extends javafx.scene.control.ListCellMaker<T, Z, B>
        implements ComboBoxListCellMakerExt<T, Z, B>
{
    ...
    /**
     * 增加集合屬性{@link ComboBoxListCell#getItems}的內容。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 增加集合屬性{@link ComboBoxListCell#getItems}的內容，排除null項目。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 設定屬性{@link ComboBoxListCell#comboBoxEditableProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 設定屬性{@link ComboBoxListCell#converterProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
     ...
     */
    @SuppressWarnings("unchecked")
    public ComboBoxListCell<T> build(javafx.util.StringConverter<T> arg0, T[] arg1)
    {
        ComboBoxListCell<T> instance = new ComboBoxListCell<T>(arg0, arg1);
        this.applyTo((Z) instance);
        this.doAfterBuild((Z) instance);
        return instance;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public ComboBoxListCell<T> build(javafx.util.StringConverter<T> arg0, javafx.collections.ObservableList<T> arg1)
    {
        ComboBoxListCell<T> instance = new ComboBoxListCell<T>(arg0, arg1);
        this.applyTo((Z) instance);
        this.doAfterBuild((Z) instance);
