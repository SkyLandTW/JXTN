 ...
 * @param <B> 建構器本身的型態(需繼承{@link TextFieldTreeCellMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class TextFieldTreeCellMaker<T extends java.lang.Object, Z extends TextFieldTreeCell<T>, B extends TextFieldTreeCellMaker<T, Z, B>>
        extends javafx.scene.control.TreeCellMaker<T, Z, B>
        implements TextFieldTreeCellMakerExt<T, Z, B>
{
    ...
    /**
     * 設定屬性{@link TextFieldTreeCell#converterProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
