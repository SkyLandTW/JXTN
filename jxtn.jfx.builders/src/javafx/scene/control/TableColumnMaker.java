 ...
 * @param <B> 建構器本身的型態(需繼承{@link TableColumnMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class TableColumnMaker<S extends java.lang.Object, T extends java.lang.Object, Z extends TableColumn<S, T>, B extends TableColumnMaker<S, T, Z, B>>
        extends javafx.scene.control.TableColumnBaseMaker<S, T, Z, B>
        implements TableColumnMakerExt<S, T, Z, B>
{
    ...
    /**
     * 增加集合屬性{@link TableColumn#getColumns}的內容，排除null項目。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
