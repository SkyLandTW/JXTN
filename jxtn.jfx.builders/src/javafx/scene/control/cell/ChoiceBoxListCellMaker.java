 ...
 * @param <B> 建構器本身的型態(需繼承{@link ChoiceBoxListCellMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class ChoiceBoxListCellMaker<T extends java.lang.Object, Z extends ChoiceBoxListCell<T>, B extends ChoiceBoxListCellMaker<T, Z, B>>
        extends javafx.scene.control.ListCellMaker<T, Z, B>
        implements ChoiceBoxListCellMakerExt<T, Z, B>
{
    ...
    /**
     * 增加集合屬性{@link ChoiceBoxListCell#getItems}的內容，排除null項目。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
