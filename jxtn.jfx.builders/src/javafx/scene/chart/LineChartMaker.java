 ...
 * @param <B> 建構器本身的型態(需繼承{@link LineChartMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class LineChartMaker<X extends java.lang.Object, Y extends java.lang.Object, Z extends LineChart<X, Y>, B extends LineChartMaker<X, Y, Z, B>>
        ...
        implements LineChartMakerExt<X, Y, Z, B>
{
    ...
    /**
     * 設定屬性{@link LineChart#createSymbolsProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
     ...
     */
    @SuppressWarnings("unchecked")
    public LineChart<X, Y> build(javafx.scene.chart.Axis<X> arg0, javafx.scene.chart.Axis<Y> arg1, javafx.collections.ObservableList<javafx.scene.chart.XYChart.Series<X, Y>> arg2)
    {
        LineChart<X, Y> instance = new LineChart<X, Y>(arg0, arg1, arg2);
        this.applyTo((Z) instance);
        this.doAfterBuild((Z) instance);
        return instance;
    }
