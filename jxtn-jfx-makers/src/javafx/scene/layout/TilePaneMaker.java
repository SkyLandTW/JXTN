 ...
 * @param <B> 建構器本身的型態(需繼承{@link TilePaneMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class TilePaneMaker<Z extends TilePane, B extends TilePaneMaker<Z, B>>
        extends javafx.scene.layout.PaneMaker<Z, B>
        implements TilePaneMakerExt<Z, B>
{
     ...
     */
    @SuppressWarnings("unchecked")
    public TilePane build(javafx.geometry.Orientation arg0, double arg1, double arg2, javafx.scene.Node[] arg3)
    {
        TilePane instance = new TilePane(arg0, arg1, arg2, arg3);
        this.applyTo((Z) instance);
        this.doAfterBuild((Z) instance);
        return instance;
    }
