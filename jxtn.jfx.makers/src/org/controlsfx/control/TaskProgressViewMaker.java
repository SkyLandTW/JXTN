 ...
 * @param <B> 建構器本身的型態(需繼承{@link TaskProgressViewMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class TaskProgressViewMaker<T extends javafx.concurrent.Task<?>, Z extends TaskProgressView<T>, B extends TaskProgressViewMaker<T, Z, B>>
        extends javafx.scene.control.ControlMaker<Z, B>
        implements TaskProgressViewMakerExt<T, Z, B>
{
    ...
    /**
     * 增加集合屬性{@link TaskProgressView#getTasks}的內容，排除null項目。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
    @SuppressWarnings("unchecked")
    public final B tasksAddNonNull(java.util.Collection<? extends T> value)
    {
        java.util.Objects.requireNonNull(value);
        this.hasTasks = true;
        if (this.valTasks == null)
    ...
    @SafeVarargs
    @SuppressWarnings("unchecked")
    public final B tasksAddNonNull(T... value)
    {
        java.util.Objects.requireNonNull(value);
        this.hasTasks = true;
        if (this.valTasks == null)
