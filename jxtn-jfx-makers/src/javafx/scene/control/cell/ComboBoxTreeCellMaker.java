 ...
 * @param <B> 建構器本身的型態(需繼承{@link ComboBoxTreeCellMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class ComboBoxTreeCellMaker<T extends java.lang.Object, Z extends ComboBoxTreeCell<T>, B extends ComboBoxTreeCellMaker<T, Z, B>>
        extends javafx.scene.control.TreeCellMaker<T, Z, B>
        implements ComboBoxTreeCellMakerExt<T, Z, B>
{
    ...
    /**
     * 增加集合屬性{@link ComboBoxTreeCell#getItems}的內容，排除null項目。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
