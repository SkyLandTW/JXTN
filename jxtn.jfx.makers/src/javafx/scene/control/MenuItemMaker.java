 ...
 * @param <B> 建構器本身的型態(需繼承{@link MenuItemMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class MenuItemMaker<Z extends MenuItem, B extends MenuItemMaker<Z, B>>
        extends jxtn.jfx.makers.AbstractMaker<Z, B>
        implements MenuItemMakerExt<Z, B>
{
    ...
    /**
     * 增加集合屬性{@link MenuItem#getStyleClass}的內容，排除null項目。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
