 ...
 * @param <B> 建構器本身的型態(需繼承{@link RadioMenuItemMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class RadioMenuItemMaker<Z extends RadioMenuItem, B extends RadioMenuItemMaker<Z, B>>
        extends javafx.scene.control.MenuItemMaker<Z, B>
        implements RadioMenuItemMakerExt<Z, B>
{
    ...
    /**
     * 設定屬性{@link RadioMenuItem#selectedProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 設定屬性{@link RadioMenuItem#toggleGroupProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
