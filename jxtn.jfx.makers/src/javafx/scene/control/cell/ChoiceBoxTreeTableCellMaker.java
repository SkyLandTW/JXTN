 ...
 * @version jfxrt.jar
 * @param <Z> 要建構的物件型態(需繼承{@link ChoiceBoxTreeTableCell})
 * @param <B> 建構器本身的型態(需繼承{@link ChoiceBoxTreeTableCellMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class ChoiceBoxTreeTableCellMaker<S extends java.lang.Object, T extends java.lang.Object, Z extends ChoiceBoxTreeTableCell<S, T>, B extends ChoiceBoxTreeTableCellMaker<S, T, Z, B>>
        extends javafx.scene.control.TreeTableCellMaker<S, T, Z, B>
        implements ChoiceBoxTreeTableCellMakerExt<S, T, Z, B>
{
    ...
    /**
     * 設定屬性{@link ChoiceBoxTreeTableCell#setConverter(javafx.util.StringConverter)}。
     *
     * @param value 新的屬性值
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 增加集合屬性{@link ChoiceBoxTreeTableCell#getItems}的內容。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 增加集合屬性{@link ChoiceBoxTreeTableCell#getItems}的內容，排除null項目。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 設定屬性{@link ChoiceBoxTreeTableCell#converterProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
     ...
     */
    @SuppressWarnings("unchecked")
    public ChoiceBoxTreeTableCell<S, T> build(javafx.util.StringConverter<T> arg0, T[] arg1)
    {
        ChoiceBoxTreeTableCell<S, T> instance = new ChoiceBoxTreeTableCell<S, T>(arg0, arg1);
        this.applyTo((Z) instance);
        this.doAfterBuild((Z) instance);
        return instance;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public ChoiceBoxTreeTableCell<S, T> build(javafx.util.StringConverter<T> arg0, javafx.collections.ObservableList<T> arg1)
    {
        ChoiceBoxTreeTableCell<S, T> instance = new ChoiceBoxTreeTableCell<S, T>(arg0, arg1);
        this.applyTo((Z) instance);
        this.doAfterBuild((Z) instance);
