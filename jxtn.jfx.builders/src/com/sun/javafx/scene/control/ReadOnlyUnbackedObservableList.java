...
public abstract class ReadOnlyUnbackedObservableList<E> implements ObservableList<E> {
    ...
    public void callObservers(Change<E> c) {
        ListListenerHelper.fireValueChangedEvent(this.listenerHelper, c);
    }
    ...
    @Override public int lastIndexOf(E o) {
        if (o == null) return -1;
    ...
    @Override public boolean contains(E o) {
        return this.indexOf(o) != -1;
    }

    @Override public boolean containsAll(Collection<? extends E> c) {
        for (E o : c) {
            if (! this.contains(o)) {
                return false;
            }
    ...
    @Override public boolean retainAll(Collection<? extends E> c) {
        throw new UnsupportedOperationException("Not supported.");
    }
