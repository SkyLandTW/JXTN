 ...
 * @param <B> 建構器本身的型態(需繼承{@link PopupFeaturesMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class PopupFeaturesMaker<Z extends PopupFeatures, B extends PopupFeaturesMaker<Z, B>>
        extends jxtn.jfx.makers.AbstractMaker<Z, B>
        implements PopupFeaturesMakerExt<Z, B>
{
