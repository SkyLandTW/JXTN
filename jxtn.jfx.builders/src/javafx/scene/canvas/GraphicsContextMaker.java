 ...
 * @param <B> 建構器本身的型態(需繼承{@link GraphicsContextMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class GraphicsContextMaker<Z extends GraphicsContext, B extends GraphicsContextMaker<Z, B>>
        extends jxtn.jfx.makers.AbstractMaker<Z, B>
        implements GraphicsContextMakerExt<Z, B>
{
