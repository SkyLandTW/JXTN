...
JNIEXPORT jint JNICALL Java_jxtn_core_unix_NativeINotify_init(JNIEnv *env, jclass thisObj) {
    return ERR(inotify_init());
}

JNIEXPORT jint JNICALL Java_jxtn_core_unix_NativeINotify_init1(JNIEnv *env, jclass thisObj,
        jint flags) {
