 ...
 * @param <B> 建構器本身的型態(需繼承{@link FloatMapMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class FloatMapMaker<Z extends FloatMap, B extends FloatMapMaker<Z, B>>
        extends jxtn.jfx.makers.AbstractMaker<Z, B>
        implements FloatMapMakerExt<Z, B>
{
    ...
    /**
     * 設定屬性{@link FloatMap#heightProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
    ...
    /**
     * 設定屬性{@link FloatMap#widthProperty}的雙向連結。
     *
     * @param value 新的屬性連結(單向)
     * @return 目前的建構器(this)
     */
