        ...
        extends javafx.scene.paint.MaterialBuilder<Z, B>
{
    ...
    private boolean boundBumpMap;
    private javafx.beans.value.ObservableValue<? extends javafx.scene.image.Image> obsrvBumpMap;

    private boolean boundDiffuseColor;
    private javafx.beans.value.ObservableValue<? extends javafx.scene.paint.Color> obsrvDiffuseColor;

    private boolean boundDiffuseMap;
    private javafx.beans.value.ObservableValue<? extends javafx.scene.image.Image> obsrvDiffuseMap;

    private boolean boundSelfIlluminationMap;
    private javafx.beans.value.ObservableValue<? extends javafx.scene.image.Image> obsrvSelfIlluminationMap;

    private boolean boundSpecularColor;
    private javafx.beans.value.ObservableValue<? extends javafx.scene.paint.Color> obsrvSpecularColor;

    private boolean boundSpecularMap;
    private javafx.beans.value.ObservableValue<? extends javafx.scene.image.Image> obsrvSpecularMap;

    private boolean boundSpecularPower;
    private javafx.beans.value.ObservableValue<? extends Double> obsrvSpecularPower;
