...
public class ContextMenuMaker<Z extends ContextMenu, B extends ContextMenuMaker<Z, B>>
        extends javafx.scene.control.PopupControlMaker<Z, B>
        implements ContextMenuMakerExt<Z, B>
{
    ...
    /**
     * 增加集合屬性{@link ContextMenu#getItems}的內容，排除null項目。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
