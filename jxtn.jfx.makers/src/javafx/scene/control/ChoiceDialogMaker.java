...
public class ChoiceDialogMaker<T extends java.lang.Object, Z extends ChoiceDialog<T>, B extends ChoiceDialogMaker<T, Z, B>>
        extends javafx.scene.control.DialogMaker<T, Z, B>
        implements ChoiceDialogMakerExt<T, Z, B>
{
    ...
    /**
     * 增加集合屬性{@link ChoiceDialog#getItems}的內容，排除null項目。
     *
     * @param value 新的集合內容
     * @return 目前的建構器(this)
     */
