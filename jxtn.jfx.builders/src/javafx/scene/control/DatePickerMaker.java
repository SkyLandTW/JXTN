...
public class DatePickerMaker<Z extends DatePicker, B extends DatePickerMaker<Z, B>>
        extends javafx.scene.control.ComboBoxBaseMaker<java.time.LocalDate, Z, B>
        implements DatePickerMakerExt<Z, B>
{
