        ...
        extends javafx.scene.control.TreeCellBuilder<T, Z, B>
{
    ...
    private javafx.beans.value.ObservableValue<? extends javafx.util.StringConverter<javafx.scene.control.TreeItem<T>>> obsrvConverter;

    private boolean boundSelectedStateCallback;
    private javafx.beans.value.ObservableValue<? extends javafx.util.Callback<javafx.scene.control.TreeItem<T>, javafx.beans.value.ObservableValue<java.lang.Boolean>>> obsrvSelectedStateCallback;
