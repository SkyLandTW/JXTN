        ...
        extends javafx.scene.control.TableColumnBaseBuilder<javafx.scene.control.TreeItem<S>, T, Z, B>
{
    ...
    private javafx.beans.value.ObservableValue<? extends javafx.util.Callback<javafx.scene.control.TreeTableColumn<S, T>, javafx.scene.control.TreeTableCell<S, T>>> obsrvCellFactory;

    private boolean boundCellValueFactory;
    private javafx.beans.value.ObservableValue<? extends javafx.util.Callback<javafx.scene.control.TreeTableColumn.CellDataFeatures<S, T>, javafx.beans.value.ObservableValue<T>>> obsrvCellValueFactory;

    private boolean boundOnEditCancel;
    private javafx.beans.value.ObservableValue<? extends javafx.event.EventHandler<javafx.scene.control.TreeTableColumn.CellEditEvent<S, T>>> obsrvOnEditCancel;

    private boolean boundOnEditCommit;
    private javafx.beans.value.ObservableValue<? extends javafx.event.EventHandler<javafx.scene.control.TreeTableColumn.CellEditEvent<S, T>>> obsrvOnEditCommit;

    private boolean boundOnEditStart;
    private javafx.beans.value.ObservableValue<? extends javafx.event.EventHandler<javafx.scene.control.TreeTableColumn.CellEditEvent<S, T>>> obsrvOnEditStart;

    private boolean boundSortType;
    private javafx.beans.value.ObservableValue<? extends javafx.scene.control.TreeTableColumn.SortType> obsrvSortType;
