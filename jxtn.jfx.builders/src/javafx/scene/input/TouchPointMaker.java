 ...
 * @param <B> 建構器本身的型態(需繼承{@link TouchPointMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class TouchPointMaker<Z extends TouchPoint, B extends TouchPointMaker<Z, B>>
        extends jxtn.jfx.makers.AbstractMaker<Z, B>
        implements TouchPointMakerExt<Z, B>
{
