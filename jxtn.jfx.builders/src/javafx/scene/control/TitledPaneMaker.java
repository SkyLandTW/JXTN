 ...
 * @param <B> 建構器本身的型態(需繼承{@link TitledPaneMaker})
 */
@javax.annotation.Generated("Generated by javafx.ftl")
@SuppressWarnings("all")
public class TitledPaneMaker<Z extends TitledPane, B extends TitledPaneMaker<Z, B>>
        extends javafx.scene.control.LabeledMaker<Z, B>
        implements TitledPaneMakerExt<Z, B>
{
