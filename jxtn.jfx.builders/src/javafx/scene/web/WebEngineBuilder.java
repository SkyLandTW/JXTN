        ...
        extends jxtn.jfx.builders.AbstractBuilder<Z, B>
{
    ...
    private boolean boundConfirmHandler;
    private javafx.beans.value.ObservableValue<? extends javafx.util.Callback<java.lang.String, java.lang.Boolean>> obsrvConfirmHandler;

    private boolean boundCreatePopupHandler;
    private javafx.beans.value.ObservableValue<? extends javafx.util.Callback<javafx.scene.web.PopupFeatures, javafx.scene.web.WebEngine>> obsrvCreatePopupHandler;

    private boolean boundJavaScriptEnabled;
    private javafx.beans.value.ObservableValue<? extends Boolean> obsrvJavaScriptEnabled;

    private boolean boundOnAlert;
    private javafx.beans.value.ObservableValue<? extends javafx.event.EventHandler<javafx.scene.web.WebEvent<java.lang.String>>> obsrvOnAlert;

    private boolean boundOnError;
    private javafx.beans.value.ObservableValue<? extends javafx.event.EventHandler<javafx.scene.web.WebErrorEvent>> obsrvOnError;

    private boolean boundOnResized;
    private javafx.beans.value.ObservableValue<? extends javafx.event.EventHandler<javafx.scene.web.WebEvent<javafx.geometry.Rectangle2D>>> obsrvOnResized;

    private boolean boundOnStatusChanged;
    private javafx.beans.value.ObservableValue<? extends javafx.event.EventHandler<javafx.scene.web.WebEvent<java.lang.String>>> obsrvOnStatusChanged;

    private boolean boundOnVisibilityChanged;
    private javafx.beans.value.ObservableValue<? extends javafx.event.EventHandler<javafx.scene.web.WebEvent<java.lang.Boolean>>> obsrvOnVisibilityChanged;

    private boolean boundPromptHandler;
    private javafx.beans.value.ObservableValue<? extends javafx.util.Callback<javafx.scene.web.PromptData, java.lang.String>> obsrvPromptHandler;

    private boolean boundUserAgent;
    private javafx.beans.value.ObservableValue<? extends String> obsrvUserAgent;

    private boolean boundUserDataDirectory;
    private javafx.beans.value.ObservableValue<? extends java.io.File> obsrvUserDataDirectory;

    private boolean boundUserStyleSheetLocation;
    private javafx.beans.value.ObservableValue<? extends String> obsrvUserStyleSheetLocation;
