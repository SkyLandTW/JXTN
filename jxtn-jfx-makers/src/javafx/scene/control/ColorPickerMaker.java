...
public class ColorPickerMaker<Z extends ColorPicker, B extends ColorPickerMaker<Z, B>>
        extends javafx.scene.control.ComboBoxBaseMaker<javafx.scene.paint.Color, Z, B>
        implements ColorPickerMakerExt<Z, B>
{
